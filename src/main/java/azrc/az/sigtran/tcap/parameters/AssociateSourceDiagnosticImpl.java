 ...
 * @author root
 */
public class AssociateSourceDiagnosticImpl implements AssociateSourceDiagnostic {
    ...
    public AssociateSourceDiagnosticImpl() {
    }

    public AssociateSourceDiagnosticImpl(DialogueServiceProviderDiagnostic dialogueServiceProviderDiagnostic) {
        this.dialogueServiceProviderDiagnostic = dialogueServiceProviderDiagnostic;
    }

    public AssociateSourceDiagnosticImpl(DialogueServiceUserDiagnostic dialogueServiceUserDiagnostic) {
