...
import azrc.az.sigtran.map.services.enquiry.MAPAnyTimeInterrogationDialogue;
import azrc.az.sigtran.map.services.enquiry.MAPRoamingNumberEnquiryDialogue;
import azrc.az.sigtran.map.services.enquiry.MAPSubscriberInformationEnquiryDialogue;
import azrc.az.sigtran.map.services.equipment.management.MAPEquipmentManagementDialogue;
import azrc.az.sigtran.map.services.ericsson.mobility.management.IN.MAPEricssonMobilityMngtINTriggeringDialogue;
import azrc.az.sigtran.map.services.errors.IncorrectAcVersion;
import azrc.az.sigtran.map.services.location.cancellation.MAPLocationCancellationDialogue;
import azrc.az.sigtran.map.services.location.info.retrieval.MAPLocationInfoRetrievalDialogue;
import azrc.az.sigtran.map.services.mobility.sms.MAPShortMessageAlertDialogue;
import azrc.az.sigtran.map.services.mobility.sms.MAPShortMessageGatewayDialogue;
import azrc.az.sigtran.map.services.mobility.sms.MAPShortMessageRelayDialogue;
import azrc.az.sigtran.map.services.mobility.ussd.MAPNetworkUnstructuredSsDialogue;
import azrc.az.sigtran.map.services.network.location.update.MAPNetworkLocationUpdateDialogue;
import azrc.az.sigtran.map.services.purging.MAPPurgeMSDialogue;
import azrc.az.sigtran.map.services.reporting.MAPMMEventReportingDialogue;
...
import azrc.az.sigtran.tcap.primitives.tc.Operation;
...
public class MAPDialogueFactory {
    ...
    private final Logger logger = LoggerFactory.getLogger(MAPDialogueFactory.class);
