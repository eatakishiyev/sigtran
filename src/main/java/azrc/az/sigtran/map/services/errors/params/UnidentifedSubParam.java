 ...
 * @author eatakishiyev
 */
public class UnidentifedSubParam {

    private ExtensionContainer extensionContainer;

    public UnidentifedSubParam() {
    }

    public UnidentifedSubParam(ExtensionContainer extensionContainer) {
    ...
    public void decode(AsnInputStream ais) throws IncorrectSyntaxException {
        try {
            ...
            if (tag == Tag.SEQUENCE
                ...
                throw new IncorrectSyntaxException(String.format("Expecting Tag[SEQUENCE] Class[UNIVERSAL]. Received Tag[%s] Class[%s]", tag, _ais.getTagClass()));
            }
