...
import azrc.az.sigtran.map.parameters.ODBGeneralData;
import azrc.az.sigtran.map.parameters.OfferedCamel4CSIs;
import azrc.az.sigtran.map.parameters.RegionalSubscriptionResponse;
import azrc.az.sigtran.map.parameters.SSList;
import azrc.az.sigtran.map.parameters.SupportedCamelPhases;
import azrc.az.sigtran.map.parameters.SupportedFeatures;
