 ...
 * @author root
 */
public class DestinationRestricted extends Message {

    private final MessageClass messageClass = MessageClass.SSNM;
    private final MessageType messageType = MessageType.DRST;
    ...
    public String toString() {
        return String.format("DestinationRestricted [NetworkAppearance = %s; RoutingContext = %s; "
                + "AffectedPointCode = %s; InfoString = %s]", this.networkAppearance,
                this.routingContext, this.affectedPointCode, infoString);
    }
