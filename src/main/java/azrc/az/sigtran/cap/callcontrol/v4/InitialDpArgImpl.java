...
import azrc.az.sigtran.cap.parameters.CGEncountered;
...
import azrc.az.isup.parameters.HighLayerCompability;
...
import azrc.az.sigtran.map.parameters.SubscriberState;
...
//    AdditionalCallingPartyNumber = >Generic number "additional calling party number"
    ...
    private void decode_(AsnInputStream ais) throws ParameterOutOfRangeException, IncorrectSyntaxException, UnexpectedDataException, IncorrectSyntaxException, IllegalNumberFormatException, ParseException {
        try {
