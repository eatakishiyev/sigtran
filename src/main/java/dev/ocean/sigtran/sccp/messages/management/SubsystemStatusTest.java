 ...
 * @author eatakishiyev
 */
public class SubsystemStatusTest implements ManagementMessage {

    private final SCMGFormatIdentifiers messageType = SCMGFormatIdentifiers.SST;
    ...
    protected SubsystemStatusTest() {
    }

    protected SubsystemStatusTest(SubSystemNumber affectedSSN, SignallingPointCode affectedPointCode, SubsystemMultiplicityIndicator subsystemMultiplicityIndicator) {
    ...
    public String toString() {
        return new StringBuilder()
                .append("SubsystemStatusTest:[")
                .append("SSN = ").append(affectedSSN)
                .append(";AffectedPointCode = ").append(affectedPointCode)
                .append(";SubsystemMultiplicity = ").append(subsystemMultiplicityIndicator)
                .append("]").toString();
    }
}
