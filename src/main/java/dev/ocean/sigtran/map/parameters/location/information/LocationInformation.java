...
import dev.ocean.sigtran.map.parameters.AgeOfLocationInformation;
import dev.ocean.sigtran.map.parameters.CellGlobalIdOrServiceAreaIdOrLAI;
import dev.ocean.sigtran.map.parameters.ExtensionContainer;
import dev.ocean.sigtran.map.parameters.ISDNAddressString;
import dev.ocean.sigtran.map.parameters.LSAIdentity;
import dev.ocean.sigtran.map.parameters.UserCSGInformation;
