...
import dev.ocean.sigtran.map.parameters.CamelInfo;
...
import dev.ocean.sigtran.map.parameters.ForwardingReason;
import dev.ocean.sigtran.map.parameters.ISTSupportIndicator;
import dev.ocean.sigtran.map.parameters.InterrogationType;
import dev.ocean.sigtran.map.parameters.NumberOfForwarding;
import dev.ocean.sigtran.map.parameters.ORPhase;
import dev.ocean.sigtran.map.parameters.SupportedCCBSPhase;
import dev.ocean.sigtran.map.parameters.SuppressMTSS;
