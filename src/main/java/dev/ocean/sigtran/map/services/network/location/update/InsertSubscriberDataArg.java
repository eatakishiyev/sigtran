...
import dev.ocean.sigtran.map.parameters.AccessRestrictionData;
import dev.ocean.sigtran.map.parameters.AgeIndicator;
import dev.ocean.sigtran.map.parameters.BearerServiceList;
import dev.ocean.sigtran.map.parameters.Category;
import dev.ocean.sigtran.map.parameters.DiameterIdentity;
import dev.ocean.sigtran.map.parameters.ExtSSInfoList;
import dev.ocean.sigtran.map.parameters.IMSI;
import dev.ocean.sigtran.map.parameters.ISDNAddressString;
import dev.ocean.sigtran.map.parameters.NAEAPrefferedCI;
import dev.ocean.sigtran.map.parameters.NetworkAccessMode;
import dev.ocean.sigtran.map.parameters.ODBData;
import dev.ocean.sigtran.map.parameters.SubscribedPeriodicLAUTimer;
import dev.ocean.sigtran.map.parameters.SubscribedPeriodicRAUTAUTimer;
import dev.ocean.sigtran.map.parameters.SubscriberStatus;
import dev.ocean.sigtran.map.parameters.TeleServiceList;
import dev.ocean.sigtran.map.parameters.VBSDataList;
import dev.ocean.sigtran.map.parameters.VGCSDataList;
import dev.ocean.sigtran.map.parameters.VlrCamelSubscriptionInfo;
import dev.ocean.sigtran.map.parameters.ZoneCodeList;
