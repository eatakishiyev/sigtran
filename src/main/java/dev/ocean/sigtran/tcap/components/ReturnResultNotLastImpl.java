 ...
 * @author root
 */
public class ReturnResultNotLastImpl implements ReturnResult {

    public static final int RETURN_RESULT_NOT_LAST = 0x07;
    public static final int TAG_RRNL_CLASS = Tag.CLASS_CONTEXT_SPECIFIC;
    public static final boolean TAG_RRNL_PRIMITIVE = false;
    private Short invokeId;
    private OperationCodeImpl operationCode;
    private ParameterImpl parameter;

    protected ReturnResultNotLastImpl() {
    }

    protected ReturnResultNotLastImpl(short invokeId) {
        this();
    ...
    public void encode(AsnOutputStream aos) throws IncorrectSyntaxException {
        try {
            ...
            aos.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, RETURN_RESULT_NOT_LAST);
            ...
            if (this.getOperationCode() != null
                ...
                this.getOperationCode().encode(aos);

                this.getParameter().encode(aos);
    ...
    public ComponentType getComponentType() {
        return ComponentType.RETUR_RESULT_NOT_LAST;
    }
