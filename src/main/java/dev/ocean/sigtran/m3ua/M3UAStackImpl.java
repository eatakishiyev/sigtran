...
public class M3UAStackImpl implements M3UAStack {
    ...
    public static final Logger logger = LogManager.getLogger(M3UAStackImpl.class);
    ...
    protected final List<AspImpl> aspList = new ArrayList<>();
    ...
    public AsImpl findAs(String name) {
        for (AsImpl as : configuredAsList) {
    ...
    public AspImpl findAsp(String name) {
