 ...
 * @author root
 */
public class DestinationAvailable extends Message {

    private final MessageClass messageClass = MessageClass.SSNM;
    private final MessageType messageType = MessageType.DAVA;
    ...
    public String toString() {
        return String.format("DestinationAvailable [NetworkAppearance = %s; RoutingContext = %s;"
                + "AffectedPointCode = %s; InfoString = %s]", networkAppearance,
                routingContext, affectedPointCode, infoString);
    }
}
