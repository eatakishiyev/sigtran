 ...
 * @author root
 */
public class DestinationStateAudit extends Message {

    private final MessageClass messageClass = MessageClass.SSNM;
    private final MessageType messageType = MessageType.DAUD;
    ...
    public String toString() {
        return String.format("DestinationStateAudit [NetworkAppearance = %s; RoutingContext = %s; "
                + "AffectedPointCode = %s; InfoString = %s]", networkAppearance, routingContext,
                affectedPointCode, infoString);
    }
