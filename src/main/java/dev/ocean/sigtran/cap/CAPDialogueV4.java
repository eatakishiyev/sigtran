...
import dev.ocean.sigtran.cap.callcontrol.v4.ApplyChargingArg;
import dev.ocean.sigtran.cap.callcontrol.v4.ConnectArgImpl;
import dev.ocean.sigtran.cap.callcontrol.v4.EstablishTemporaryConnectionArg;
import dev.ocean.sigtran.cap.callcontrol.v4.EventReportBCSMArgImpl;
import dev.ocean.sigtran.cap.callcontrol.v4.InitialDpArgImpl;
import dev.ocean.sigtran.cap.callcontrol.v4.PlayAnnouncementArg;
import dev.ocean.sigtran.cap.callcontrol.v4.ReleaseCallArg;
import dev.ocean.sigtran.cap.callcontrol.v4.RequestReportBCSMEventArgImpl;
...
import dev.ocean.sigtran.cap.smscontrol.general.ConnectSMSArg;
import dev.ocean.sigtran.cap.smscontrol.general.ReleaseSMSArg;
import dev.ocean.sigtran.cap.smscontrol.v4.EventReportSMSArg;
import dev.ocean.sigtran.cap.smscontrol.v4.InitialDpSMSArgImpl;
import dev.ocean.sigtran.cap.smscontrol.v4.RequestReportSMSEventArg;
...
public class CAPDialogueV4 extends CAPDialogue {
    ...
    private final Logger logger = LogManager.getLogger(CAPDialogueV4.class);
