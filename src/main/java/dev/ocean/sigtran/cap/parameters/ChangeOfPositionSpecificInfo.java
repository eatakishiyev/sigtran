...
public class ChangeOfPositionSpecificInfo {
    ...
    public void encode(int tagClass, int tag, AsnOutputStream aos) throws AsnException, dev.ocean.sigtran.common.exceptions.IncorrectSyntaxException, IOException, IllegalNumberFormatException, UnexpectedDataException {
