...
import dev.ocean.isup.parameters.ClosedUserGroupInterlockCode;
import dev.ocean.isup.parameters.ForwardCallIndicators;
...
import dev.ocean.isup.parameters.NatureOfConnectionIndicators;
import dev.ocean.isup.parameters.OptionalForwardCallIndicators;
import dev.ocean.isup.parameters.RedirectingNumber;
import dev.ocean.isup.parameters.TransitNetworkSelection;
...
import dev.ocean.isup.parameters.CCSS;
import dev.ocean.isup.parameters.CallOfferingTreatmentIndicators;
import dev.ocean.isup.parameters.CallReference;
import dev.ocean.isup.parameters.CalledDirectoryNumber;
import dev.ocean.isup.parameters.CalledINNumber;
import dev.ocean.isup.parameters.CallingGeodeticLocation;
import dev.ocean.isup.parameters.CircuitAssignmentMap;
import dev.ocean.isup.parameters.CollectCallRequest;
import dev.ocean.isup.parameters.ConnectionRequest;
import dev.ocean.isup.parameters.EchoControlInformation;
import dev.ocean.isup.parameters.ForwardGVNS;
import dev.ocean.isup.parameters.GenericNotificationIndicator;
import dev.ocean.isup.parameters.HopCounter;
import dev.ocean.isup.parameters.IsupParameter;
import dev.ocean.isup.parameters.MLPPPrecedence;
import dev.ocean.isup.parameters.NetworkManagementControls;
import dev.ocean.isup.parameters.NetworkRoutingNumber;
import dev.ocean.isup.parameters.NetworkSpecificFacility;
import dev.ocean.isup.parameters.NumberPortabilityForwardInformation;
import dev.ocean.isup.parameters.OriginalCalledINNumber;
import dev.ocean.isup.parameters.OriginalCalledNumber;
import dev.ocean.isup.parameters.ParameterCompatibilityInformation;
import dev.ocean.isup.parameters.ParameterFactory;
import dev.ocean.isup.parameters.PivotCapability;
import dev.ocean.isup.parameters.PivotCounter;
import dev.ocean.isup.parameters.PivotRoutingForwardInformation;
import dev.ocean.isup.parameters.PropagationDelayCounter;
import dev.ocean.isup.parameters.QoRCapability;
import dev.ocean.isup.parameters.RedirectCapability;
import dev.ocean.isup.parameters.RedirectCounter;
import dev.ocean.isup.parameters.RedirectForwardInformation;
...
import dev.ocean.isup.parameters.SignallingPointCode;
import dev.ocean.isup.enums.TransmissionMediumRequirement;
import dev.ocean.isup.enums.TransmissionMediumRequirementPrime;
import dev.ocean.isup.parameters.UIDCapabilityIndicators;
import dev.ocean.isup.parameters.UserServiceInformation;
import dev.ocean.isup.parameters.UserServiceInformationPrime;
import dev.ocean.isup.parameters.UserTeleServiceInformation;
import dev.ocean.isup.parameters.UserToUserIndicators;
import dev.ocean.isup.parameters.UserToUserInformation;
