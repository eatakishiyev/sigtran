...
import dev.ocean.isup.enums.Screening;
import static dev.ocean.isup.parameters.IsupParameter.CALL_TRANSFER_NUMBER;
 ...
 * @author eatakishiyev
 */
public class ConnectedNumber implements IsupParameter {
     ...
     * @param address;
     */
    public ConnectedNumber(NatureOfAddress natureOfAddress,
