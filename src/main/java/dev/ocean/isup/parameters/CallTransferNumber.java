 ...
 * @author eatakishiyev
 */
public class CallTransferNumber implements IsupParameter {
     ...
     * @param address;
     */
    public CallTransferNumber(NatureOfAddress natureOfAddress,
